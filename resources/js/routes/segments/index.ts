...
/**
* @see \App\Http\Controllers\SegmentController::index
 * @see app/Http/Controllers/SegmentController.php:21
...
/**
* @see \App\Http\Controllers\SegmentController::create
 * @see app/Http/Controllers/SegmentController.php:41
...
/**
* @see \App\Http\Controllers\SegmentController::store
 * @see app/Http/Controllers/SegmentController.php:49
 * @route '/dashboard/segments'
 */
...
/**
* @see \App\Http\Controllers\SegmentController::edit
 * @see app/Http/Controllers/SegmentController.php:73
...
/**
* @see \App\Http\Controllers\SegmentController::update
 * @see app/Http/Controllers/SegmentController.php:83
...
/**
* @see \App\Http\Controllers\SegmentController::destroy
 * @see app/Http/Controllers/SegmentController.php:95
 * @route '/dashboard/segments/{segment}'
 */
...
/**
* @see \App\Http\Controllers\Segment\AssociateCompanyController::attachCompany
 * @see app/Http/Controllers/Segment/AssociateCompanyController.php:14
 * @route '/dashboard/segments/{segment}/attach-company'
 */
export const attachCompany = (args: { segment: number | { id: number } } | [segment: number | { id: number } ] | number | { id: number }, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'post',
} => ({
    url: attachCompany.url(args, options),
    method: 'post',
})

attachCompany.definition = {
    methods: ['post'],
 ...
 * @route '/dashboard/segments/{segment}/attach-company'
 */
attachCompany.url = (args: { segment: number | { id: number } } | [segment: number | { id: number } ] | number | { id: number }, options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { segment: args }
    }
    ...
    return attachCompany.definition.url
            .replace('{segment}', parsedArgs.segment.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/dashboard/segments/{segment}/attach-company'
 */
attachCompany.post = (args: { segment: number | { id: number } } | [segment: number | { id: number } ] | number | { id: number }, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'post',
} => ({
    url: attachCompany.url(args, options),
...
/**
* @see \App\Http\Controllers\Segment\DissociateCompanyController::detachCompany
 * @see app/Http/Controllers/Segment/DissociateCompanyController.php:15
 * @route '/dashboard/segments/{segment}/detach-company/{company}'
 */
export const detachCompany = (args: { segment: number | { id: number }, company: number | { id: number } } | [segment: number | { id: number }, company: number | { id: number } ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
    url: detachCompany.url(args, options),
    method: 'delete',
})

detachCompany.definition = {
    methods: ['delete'],
 ...
 * @route '/dashboard/segments/{segment}/detach-company/{company}'
 */
detachCompany.url = (args: { segment: number | { id: number }, company: number | { id: number } } | [segment: number | { id: number }, company: number | { id: number } ], options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (Array.isArray(args)) {
        args = {
                    segment: args[0],
                    company: args[1],
    ...
    return detachCompany.definition.url
            .replace('{segment}', parsedArgs.segment.toString())
 ...
 * @route '/dashboard/segments/{segment}/detach-company/{company}'
 */
detachCompany.delete = (args: { segment: number | { id: number }, company: number | { id: number } } | [segment: number | { id: number }, company: number | { id: number } ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
    url: detachCompany.url(args, options),
